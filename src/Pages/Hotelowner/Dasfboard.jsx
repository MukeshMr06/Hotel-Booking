...
const Dasfboard = () => {
    ...
    return (
       ...
       <div>
            <Title align="left" font="outfit" title='Dashboard' subTitle='Monitor your room listings, track
             bookings and analyze revenue-all in one place. Stay updated with real-time insights to ensure smooth
               operations.'/>
            ...
            <div className='flex gap-4 my-8'>
                ...
                <div className='bg-primary/3 border border-primary/10 rounded flex p-4 pr-8'>
                    ...
                    <div className='flex flex-col sm:ml-4 font-medium'>
                        ...
                        <p className='text-neurtal-400 text-base'>{dashboardData.totalBookings}</p>
                    </div>
                </div>
                {/* Total Revenue */}
                <div>
                    <div className='bg-primary/3 border border-primary/10 rounded flex p-4 pr-8'>
                        ...
                        <div className='flex flex-col sm:ml-4 font-medium'>
                            ...
                            <p className='text-neurtal-400 text-base'>$ {dashboardData.totalRevenue}</p>
                        </div>
                    </div>
                </div>
            </div>
