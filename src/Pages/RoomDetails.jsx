    ...
    return room && (
        <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
            ...
            <div className='flex flex-col md:flex-row items-start md:items-center gap-2'>
                ...
                <p className='text-sm font-inter py-1.5 px-3 text-white bg-orange-500 rounded-2xl'>20 % off</p>
            </div>
                ...
                <div className='grid grid-cols-2 gap-4 lg:w-1/2 w-full'>
                    {room?.images.length > 1 && room.images.map((image, index) => (
                        <img onClick={() => setMainImage(image)}
                            key={index} src={image} alt="" className={`w-full rounded-xl shadow-md object-cover cursor-pointer
            ...
            bg-white shadow-lg p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
                ...
                <button type='submit' className='bg-blue-700 hover:bg-blue-600 transition-all active-scale p-2 text-white rounded-md mt-2 md:px-25 py-3 cursor-pointer'>
                    Check Availability
                </button>
            </form>
            ...
            <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
                <p>Guest will be allocated on the ground floor according to availability.
                    ...
                    price quoted is for two guest,at the guest slot please mark the number of guests to guest
                    the exact price for groups. The Guests will be allocated ground floor according to availability.
                    You get the comfortable two bedroom apartment that has a true city feelings.
                </p>
            </div>
            ...
            <div className='flex flex-col items-start gap-4'>
                ...
                <button className='px-6 py-2.5 mt-4 rounded text-white bg-blue-700
                hover:bg-blue-500 transition-all cursor-pointer'>Contact Now</button>
            </div>
