            ...
            <form className='flex bg-white rounded-xl max-w-4xl max-md:mx-2'>
                ...
                <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
                    ...
                    <div className='w-full mt-4'>
                        <label className='font-medium text-gray-500' htmlFor="Hotel">Hotel name </label>
                        <input id='Hotel' type="text" placeholder='Type here' className='border border-gray-200
                    ...
                    {/* Address */}
                    <div className='w-full mt-4'>
                        <label className='font-medium text-gray-500' htmlFor="Adress">Adress </label>
                        <input id='Adress' type="text" placeholder='Type here' className='border border-gray-200
                        rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light' required />
                    </div>
                    ...
                    <button className='bg-indigo-500 mt-4 hover:bg-indigo-600 transition-all text-white 
                      mr-auto px-6 py-2 rounded cursor-pointer'>Register</button>
                </div>
            </form>
        </div>
    )
